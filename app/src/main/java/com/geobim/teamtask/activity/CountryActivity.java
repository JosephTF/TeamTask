        ...
        switch (view.getId()) {
            ...
            case R.id.ib_country_search:
                if (rl_country_search.getVisibility() != View.VISIBLE) {
                    Animation title_fadeout = AnimationUtils.loadAnimation(CountryActivity.this, R.anim.anim_fade_out);
                    tv_title.startAnimation(title_fadeout);
                    tv_title.setVisibility(View.GONE);
                    Animation search_open = AnimationUtils.loadAnimation(CountryActivity.this, R.anim.anim_country_search_open);
                    rl_country_search.startAnimation(search_open);
                    rl_country_search.setVisibility(View.VISIBLE);
                } else {
                    Animation openAnim = AnimationUtils.loadAnimation(CountryActivity.this, R.anim.anim_country_search_close);
                    rl_country_search.startAnimation(openAnim);
                    rl_country_search.setVisibility(View.GONE);
                    Animation title_fadein = AnimationUtils.loadAnimation(CountryActivity.this, R.anim.anim_fade_in);
