package com.geobim.teamtask.ui.FragmentView;
...
import com.geobim.teamtask.ui.FragmentView.entity.TabEntity;
...
import com.geobim.teamtask.ui.FragmentView.view.CommonTabLayout;
import com.geobim.teamtask.ui.FragmentView.widget.MyViewPager;
...
public class TabLayoutSmk extends FrameLayout {
    ...
    public TabLayoutSmk(Context context, AttributeSet attrs) {
        ...
        LayoutInflater.from(context).inflate(R.layout.tablayout_view_tab, this);
        initView();
    }
