package com.geobim.teamtask.ui.DateWheelView;
...
public class WheelView extends View {
    ...
    private void init(Context context) {
        ...
        mPaint.setTextSize(spTopx(context, 20));
        ...
        selectPaint.setTextSize(spTopx(context, 22));
        ...
        centerLinePaint.setColor(getResources().getColor(R.color.wheel_unselect_text1));
