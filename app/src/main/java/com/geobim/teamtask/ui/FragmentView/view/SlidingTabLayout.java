...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
     ...
     * 每个item是否横向平分屏幕剧中
     */
    public void setViewPager(ViewPager vp, boolean horizontalCenter) {
        this.mHorizontalCenter = horizontalCenter;
...
*/
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            tabView = View.inflate(mContext, R.layout.tablayout_tab_layout, null);
    ...
    public void addNewTab(String title) {
        View tabView = View.inflate(mContext, R.layout.tablayout_tab_layout, null);
        if (mTitles != null) {
            mTitles.add(title);
        }
    ...
    private void addTab(final int position, String title, View tabView) {
        ...
        if (mHorizontalCenter) {
            ...
            RelativeLayout.LayoutParams linearParams = (RelativeLayout.LayoutParams) tv_tab_title.getLayoutParams();
            linearParams.width = width / mTabCount;
            tv_tab_title.setLayoutParams(linearParams);
        }
