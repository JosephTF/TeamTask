package com.geobim.teamtask.util.swipebacklayout;
...
public class SwipeBackLayout extends FrameLayout {
    ...
    /**
     * Set a colors to use for the scrim that obscures primary content while a
     * drawer is open.
     *
